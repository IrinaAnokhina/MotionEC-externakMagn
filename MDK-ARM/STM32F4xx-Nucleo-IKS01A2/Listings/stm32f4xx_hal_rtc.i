...
#line 176 "..\\..\\..\\..\\..\\..\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_rtc.c"
...
#line 281 "..\\..\\..\\..\\..\\..\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_rtc.c"
  ...
  else
  {
    ...
    hrtc->Instance->CR &= ((uint32_t)~((0x1UL << (6U)) | (0x3UL << (21U)) | (0x1UL << (20U))));
    ...
    hrtc->Instance->TAFCR &= (uint32_t)~(0x1UL << (18U));
...
HAL_StatusTypeDef HAL_RTC_DeInit(RTC_HandleTypeDef *hrtc)
{
  ...
  else
  {
    ...
    while(((hrtc->Instance->ISR) & (0x1UL << (2U))) == (uint32_t)RESET)
    {
...
#line 449 "..\\..\\..\\..\\..\\..\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_rtc.c"
...
#line 658 "..\\..\\..\\..\\..\\..\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_rtc.c"
...
HAL_StatusTypeDef HAL_RTC_SetTime(RTC_HandleTypeDef *hrtc, RTC_TimeTypeDef *sTime, uint32_t Format)
{
  ...
  {
    if((hrtc->Instance->CR & (0x1UL << (6U))) != (uint32_t)RESET)
    {
      ((void)0U);
      ((void)0U);
    }
  ...
  else
  {
    ...
    hrtc->Instance->CR &= (uint32_t)~(0x1UL << (18U));
...
HAL_StatusTypeDef HAL_RTC_GetTime(RTC_HandleTypeDef *hrtc, RTC_TimeTypeDef *sTime, uint32_t Format)
{
  ...
  sTime->Seconds = (uint8_t)(tmpreg & ((0x7UL << (4U)) | (0xFUL << (0U))));
  sTime->TimeFormat = (uint8_t)((tmpreg & ((0x1UL << (22U)))) >> 16U);
...
HAL_StatusTypeDef HAL_RTC_GetDate(RTC_HandleTypeDef *hrtc, RTC_DateTypeDef *sDate, uint32_t Format)
{
  ...
  sDate->Date = (uint8_t)(datetmpreg & ((0x3UL << (4U)) | (0xFUL << (0U))));
...
#line 1108 "..\\..\\..\\..\\..\\..\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_rtc.c"
  }
  else
  {
    if((hrtc->Instance->CR & (0x1UL << (6U))) != (uint32_t)RESET)
...
#line 1141 "..\\..\\..\\..\\..\\..\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_rtc.c"
  }
...
HAL_StatusTypeDef HAL_RTC_SetAlarm_IT(RTC_HandleTypeDef *hrtc, RTC_AlarmTypeDef *sAlarm, uint32_t Format)
{
  ...
  if(Format == 0x00000000U)
  {
    ...
    tmpreg = (((uint32_t)RTC_ByteToBcd2(sAlarm->AlarmTime.Hours) << 16U) |               ((uint32_t)RTC_ByteToBcd2(sAlarm->AlarmTime.Minutes) << 8U) |               ((uint32_t)RTC_ByteToBcd2(sAlarm->AlarmTime.Seconds)) |               ((uint32_t)(sAlarm->AlarmTime.TimeFormat) << 16U) |               ((uint32_t)RTC_ByteToBcd2(sAlarm->AlarmDateWeekDay) << 24U) |               ((uint32_t)sAlarm->AlarmDateWeekDaySel) |               ((uint32_t)sAlarm->AlarmMask));
#line 1290 "..\\..\\..\\..\\..\\..\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_rtc.c"
  }
  else
  {
    if((hrtc->Instance->CR & (0x1UL << (6U))) != (uint32_t)RESET)
    ...
    tmpreg = (((uint32_t)(sAlarm->AlarmTime.Hours) << 16U) |               ((uint32_t)(sAlarm->AlarmTime.Minutes) << 8U) |               ((uint32_t) sAlarm->AlarmTime.Seconds) |               ((uint32_t)(sAlarm->AlarmTime.TimeFormat) << 16U) |               ((uint32_t)(sAlarm->AlarmDateWeekDay) << 24U) |               ((uint32_t)sAlarm->AlarmDateWeekDaySel) |               ((uint32_t)sAlarm->AlarmMask));
#line 1322 "..\\..\\..\\..\\..\\..\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_rtc.c"
  }
  ...
  if(sAlarm->Alarm == (0x1UL << (8U)))
  {
    ...
    ((hrtc)->Instance ->ISR) = (~((0x00000100U) | (0x1UL << (7U)))|((hrtc)->Instance ->ISR & (0x1UL << (7U))));
  ...
  (((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->IMR |= ((uint32_t)(0x1UL << (17U))));

  ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->RTSR |= ((uint32_t)(0x1UL << (17U)));
...
HAL_StatusTypeDef HAL_RTC_GetAlarm(RTC_HandleTypeDef *hrtc, RTC_AlarmTypeDef *sAlarm, uint32_t Alarm, uint32_t Format)
{
  ...
  sAlarm->AlarmTime.Hours = (uint32_t)((tmpreg & ((0x3UL << (20U)) | (0xFUL << (16U)))) >> 16U);
  sAlarm->AlarmTime.Minutes = (uint32_t)((tmpreg & ((0x7UL << (12U)) | (0xFUL << (8U)))) >> 8U);
  sAlarm->AlarmTime.Seconds = (uint32_t)(tmpreg & ((0x7UL << (4U)) | (0xFUL << (0U))));
  sAlarm->AlarmTime.TimeFormat = (uint32_t)((tmpreg & (0x1UL << (22U))) >> 16U);
  sAlarm->AlarmTime.SubSeconds = (uint32_t) subsecondtmpreg;
  sAlarm->AlarmDateWeekDay = (uint32_t)((tmpreg & ((0x3UL << (28U)) | (0xFUL << (24U)))) >> 24U);
...
void HAL_RTC_AlarmIRQHandler(RTC_HandleTypeDef* hrtc)
{
  ...
  (((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->PR = ((uint32_t)(0x1UL << (17U))));
...
HAL_StatusTypeDef HAL_RTC_WaitForSynchro(RTC_HandleTypeDef* hrtc)
{
  ...
  while((hrtc->Instance->ISR & (0x1UL << (5U))) == (uint32_t)RESET)
  {
    if((HAL_GetTick() - tickstart ) > 1000)
    {
      return HAL_TIMEOUT;
...
HAL_StatusTypeDef RTC_EnterInitMode(RTC_HandleTypeDef* hrtc)
{
  ...
  if((hrtc->Instance->ISR & (0x1UL << (6U))) == (uint32_t)RESET)
  {
    ...
    while((hrtc->Instance->ISR & (0x1UL << (6U))) == (uint32_t)RESET)
    {
      if((HAL_GetTick() - tickstart ) > 1000)
      {
        return HAL_TIMEOUT;
