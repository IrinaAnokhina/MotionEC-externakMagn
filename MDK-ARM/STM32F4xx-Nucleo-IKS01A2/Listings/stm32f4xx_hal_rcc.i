...
#line 70 "..\\..\\..\\..\\..\\..\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_rcc.c"
  ...
  switch (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->CFGR & (0x3UL << (2U)))
  {
    ...
    case 0x00000008U:   
    {
      ...
      if(((uint32_t)(((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLCFGR & (0x1UL << (22U)))) != 0x00000000U)
      {
        ...
        pllvco = (uint32_t) ((((uint64_t) ((uint32_t)8000000) * ((uint64_t) ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLCFGR & (0x1FFUL << (6U))) >> (6U))))) / (uint64_t)pllm);
      }
      else
      {
         
        pllvco = (uint32_t) ((((uint64_t) ((uint32_t)16000000) * ((uint64_t) ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLCFGR & (0x1FFUL << (6U))) >> (6U))))) / (uint64_t)pllm);
      }
