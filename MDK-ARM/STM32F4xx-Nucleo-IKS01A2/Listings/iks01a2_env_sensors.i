...
#line 48 "..\\..\\..\\..\\..\\..\\Drivers\\BSP\\IKS01A2\\iks01a2_env_sensors.c"
...
static ENV_SENSOR_FuncDrv_t *EnvFuncDrv[(1U + 1U + 0 + 0)][3U];
static ENV_SENSOR_CommonDrv_t *EnvDrv[(1U + 1U + 0 + 0)];
static IKS01A2_ENV_SENSOR_Ctx_t EnvCtx[(1U + 1U + 0 + 0)];
...
int32_t IKS01A2_ENV_SENSOR_Init(uint32_t Instance, uint32_t Functions)
{
  ...
  switch (Instance)
  {
    ...
    case 0:
      if (HTS221_0_Probe(Functions) != 0)
      {
        return -1;
      }
      if (EnvDrv[Instance]->GetCapabilities(EnvCompObj[Instance], (void *)&cap) != 0)
      {
        return -7;
      }
    ...
    case (1U):
      if (LPS22HB_0_Probe(Functions) != 0)
      {
        return -1;
      }
      if (EnvDrv[Instance]->GetCapabilities(EnvCompObj[Instance], (void *)&cap) != 0)
...
#line 207 "..\\..\\..\\..\\..\\..\\Drivers\\BSP\\IKS01A2\\iks01a2_env_sensors.c"

#line 232 "..\\..\\..\\..\\..\\..\\Drivers\\BSP\\IKS01A2\\iks01a2_env_sensors.c"
  ...
  for (i = 0; i < 3U; i++)
  {
    ...
    {
      if (EnvFuncDrv[Instance][FunctionIndex[function]]->Enable(EnvCompObj[Instance]) != 0)
      {
        return -5;
      }
    }
...
int32_t IKS01A2_ENV_SENSOR_DeInit(uint32_t Instance)
{
  ...
  if (Instance >= (1U + 1U + 0 + 0))
  {
    ret = -2;
  }
  else if (EnvDrv[Instance]->DeInit(EnvCompObj[Instance]) != 0)
  {
    ret = -5;
  }
  else
...
int32_t IKS01A2_ENV_SENSOR_GetCapabilities(uint32_t Instance, IKS01A2_ENV_SENSOR_Capabilities_t *Capabilities)
{
  ...
  else if (EnvDrv[Instance]->GetCapabilities(EnvCompObj[Instance], Capabilities) != 0)
  {
    ret = -7;
  }
  else
...
int32_t IKS01A2_ENV_SENSOR_ReadID(uint32_t Instance, uint8_t *Id)
{
  ...
  else if (EnvDrv[Instance]->ReadID(EnvCompObj[Instance], Id) != 0)
  {
    ret = -7;
  }
  else
...
int32_t IKS01A2_ENV_SENSOR_Disable(uint32_t Instance, uint32_t Function)
{
  ...
  else
  {
    if ((EnvCtx[Instance].Functions & Function) == Function)
    {
      if (EnvFuncDrv[Instance][FunctionIndex[Function]]->Disable(EnvCompObj[Instance]) != 0)
      {
        ret = -5;
      }
      else
...
int32_t IKS01A2_ENV_SENSOR_GetOutputDataRate(uint32_t Instance, uint32_t Function, float *Odr)
{
  ...
  else
  {
    if ((EnvCtx[Instance].Functions & Function) == Function)
    {
      if (EnvFuncDrv[Instance][FunctionIndex[Function]]->GetOutputDataRate(EnvCompObj[Instance], Odr) != 0)
      {
        ret = -5;
      }
      else
...
int32_t IKS01A2_ENV_SENSOR_SetOutputDataRate(uint32_t Instance, uint32_t Function, float Odr)
{
  ...
  else
  {
    if ((EnvCtx[Instance].Functions & Function) == Function)
    {
      if (EnvFuncDrv[Instance][FunctionIndex[Function]]->SetOutputDataRate(EnvCompObj[Instance], Odr) != 0)
      {
        ret = -5;
      }
      else
...
int32_t IKS01A2_ENV_SENSOR_GetValue(uint32_t Instance, uint32_t Function, float *Value)
{
  ...
  else
  {
    if ((EnvCtx[Instance].Functions & Function) == Function)
    {
      if (EnvFuncDrv[Instance][FunctionIndex[Function]]->GetValue(EnvCompObj[Instance], Value) != 0)
      {
        ret = -5;
      }
      else
...
static int32_t HTS221_0_Probe(uint32_t Functions)
{
  ...
  if (HTS221_RegisterBusIO(&hts221_obj_0, &io_ctx) != 0)
  {
    ret = -7;
  }
  else if (HTS221_ReadID(&hts221_obj_0, &id) != 0)
  {
    ret = -7;
  }
  else if (id != 0xBCU)
  ...
  else
  {
    ...
    EnvCtx[0].Functions = ((uint32_t)cap.Temperature) | ((uint32_t)cap.Pressure << 1) | ((
                                           uint32_t)cap.Humidity << 2);

    EnvCompObj[0] = &hts221_obj_0;
     
    EnvDrv[0] = (ENV_SENSOR_CommonDrv_t *)(void *)&HTS221_COMMON_Driver;

    if ((ret == 0) && ((Functions & 1U) == 1U) && (cap.Temperature == 1U))
    {
       
      EnvFuncDrv[0][FunctionIndex[1U]] = (ENV_SENSOR_FuncDrv_t *)(void *)&HTS221_TEMP_Driver;

      if (EnvDrv[0]->Init(EnvCompObj[0]) != 0)
      {
        ret = -5;
      }
      else
    ...
    if ((ret == 0) && ((Functions & 4U) == 4U) && (cap.Humidity == 1U))
    {
       
      EnvFuncDrv[0][FunctionIndex[4U]] = (ENV_SENSOR_FuncDrv_t *)(void *)&HTS221_HUM_Driver;
...
static int32_t LPS22HB_0_Probe(uint32_t Functions)
{
  ...
  if (LPS22HB_RegisterBusIO(&lps22hb_obj_0, &io_ctx) != 0)
  {
    ret = -7;
  }
  else if (LPS22HB_ReadID(&lps22hb_obj_0, &id) != 0)
  {
    ret = -7;
  }
  else if (id != 0xB1U)
  ...
  else
  {
    ...
    EnvCtx[(1U)].Functions = ((uint32_t)cap.Temperature) | ((uint32_t)cap.Pressure << 1) | ((
                                            uint32_t)cap.Humidity << 2);

    EnvCompObj[(1U)] = &lps22hb_obj_0;
     
    EnvDrv[(1U)] = (ENV_SENSOR_CommonDrv_t *)(void *)&LPS22HB_COMMON_Driver;

    if ((ret == 0) && ((Functions & 1U) == 1U) && (cap.Temperature == 1U))
    {
       
      EnvFuncDrv[(1U)][FunctionIndex[1U]] = (ENV_SENSOR_FuncDrv_t *)(void *)&LPS22HB_TEMP_Driver;

      if (EnvDrv[(1U)]->Init(EnvCompObj[(1U)]) != 0)
      {
        ret = -5;
      }
      else
    ...
    if ((ret == 0) && ((Functions & 2U) == 2U) && (cap.Pressure == 1U))
    {
       
      EnvFuncDrv[(1U)][FunctionIndex[2U]] = (ENV_SENSOR_FuncDrv_t *)(void *)&LPS22HB_PRESS_Driver;
...
#line 790 "..\\..\\..\\..\\..\\..\\Drivers\\BSP\\IKS01A2\\iks01a2_env_sensors.c"

#line 875 "..\\..\\..\\..\\..\\..\\Drivers\\BSP\\IKS01A2\\iks01a2_env_sensors.c"
