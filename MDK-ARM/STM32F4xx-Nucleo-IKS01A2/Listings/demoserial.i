...
static uint8_t PresentationString[] = {"MEMS shield demo," "12" "," "2.1.0" "," "1.1.1" "," "IKS01A2"};
 ...
 
{
  ...
  switch (Msg->Data[2])    
  {
    ...
    case 0x08:
      ...
      if ((SensorsEnabled & 0x00000040U) == 0x00000040U)
      {
    ...
    case 0x09:
      ...
      (void)IKS01A2_ENV_SENSOR_Disable((1U), 2U);
      (void)IKS01A2_ENV_SENSOR_Disable(0, 1U);
      (void)IKS01A2_ENV_SENSOR_Disable(0, 4U);
      (void)IKS01A2_MOTION_SENSOR_Disable((1U), 2U);
      (void)IKS01A2_MOTION_SENSOR_Disable(0, 1U);
      (void)IKS01A2_MOTION_SENSOR_Disable((1U + 1U), 4U);
