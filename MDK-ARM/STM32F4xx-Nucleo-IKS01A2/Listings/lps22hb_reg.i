#line 1 "..\\..\\..\\..\\..\\..\\Drivers\\BSP\\Components\\lps22hb\\lps22hb_reg.c"
...
#line 38 "..\\..\\..\\..\\..\\..\\Drivers\\BSP\\Components\\lps22hb\\lps22hb_reg.c"
...
int32_t lps22hb_autozero_rst_set(lps22hb_ctx_t *ctx, uint8_t val)
{
  ...
  ret = lps22hb_read_reg(ctx, 0x0BU,
                         (uint8_t*)&interrupt_cfg, 1);
  if(ret == 0){
    interrupt_cfg.reset_az = val;
    ret = lps22hb_write_reg(ctx, 0x0BU,
                            (uint8_t*)&interrupt_cfg, 1);
  }
  return ret;
}
...
int32_t lps22hb_block_data_update_set(lps22hb_ctx_t *ctx, uint8_t val)
{
  ...
  ret = lps22hb_read_reg(ctx, 0x10U, (uint8_t*)&ctrl_reg1, 1);
  if(ret == 0){
    ctrl_reg1.bdu = val;
    ret = lps22hb_write_reg(ctx, 0x10U, (uint8_t*)&ctrl_reg1, 1);
  }
  return ret;
}
...
int32_t lps22hb_one_shoot_trigger_set(lps22hb_ctx_t *ctx, uint8_t val)
{
  ...
  ret = lps22hb_read_reg(ctx, 0x11U, (uint8_t*)&ctrl_reg2, 1);
  if(ret == 0){
    ctrl_reg2.one_shot = val;
    ret = lps22hb_write_reg(ctx, 0x11U, (uint8_t*)&ctrl_reg2, 1);
  }
  return ret;
}
...
{
  int32_t ret;
  ret =  lps22hb_write_reg(ctx, 0x15U, buff, 3);
  return ret;
}
...
{
  int32_t ret;
  ret =  lps22hb_read_reg(ctx, 0x15U, buff, 3);
  return ret;
}
...
{
  int32_t ret;
  ret =  lps22hb_write_reg(ctx, 0x18U, buff, 2);
  return ret;
}
...
{
  int32_t ret;
  ret =  lps22hb_read_reg(ctx, 0x18U, buff, 2);
  return ret;
}
...
int32_t lps22hb_press_data_ready_get(lps22hb_ctx_t *ctx, uint8_t *val)
{
  ...
  ret = lps22hb_read_reg(ctx, 0x27U, (uint8_t*)&status, 1);
  *val = status.p_da;
...
{
  int32_t ret;
  ret =  lps22hb_read_reg(ctx, 0x28U, buff, 3);
  return ret;
}
...
{
  int32_t ret;
  ret =  lps22hb_read_reg(ctx, 0x2BU, (uint8_t*) buff, 2);
  return ret;
}
...
{
  int32_t ret;
  ret =  lps22hb_read_reg(ctx, 0x33U, (uint8_t*) buff, 1);
  return ret;
}
...
{
  int32_t ret;
  ret =  lps22hb_read_reg(ctx, 0x0FU, (uint8_t*) buff, 1);
  return ret;
}
...
int32_t lps22hb_low_power_set(lps22hb_ctx_t *ctx, uint8_t val)
{
  ...
  ret = lps22hb_read_reg(ctx, 0x1AU, (uint8_t*)&res_conf, 1);
  if(ret == 0){
    res_conf.lc_en = val;
    ret = lps22hb_write_reg(ctx, 0x1AU, (uint8_t*)&res_conf, 1);
  }
  return ret;
}
...
int32_t lps22hb_boot_status_get(lps22hb_ctx_t *ctx, uint8_t *val)
{
  ...
  ret = lps22hb_read_reg(ctx, 0x25U, (uint8_t*)&int_source, 1);
...
{
  int32_t ret;
  ret =  lps22hb_read_reg(ctx, 0x26U, (uint8_t*) val, 2);
  return ret;
}
...
{
  int32_t ret;
  ret =  lps22hb_write_reg(ctx, 0x0CU, (uint8_t*) buff, 2);
  return ret;
}
...
{
  int32_t ret;
  ret =  lps22hb_read_reg(ctx, 0x0CU, (uint8_t*) buff, 2);
  return ret;
}
...
int32_t lps22hb_int_pin_mode_set(lps22hb_ctx_t *ctx, lps22hb_int_s_t val)
{
  ...
  ret = lps22hb_read_reg(ctx, 0x12U, (uint8_t*)&ctrl_reg3, 1);
  if(ret == 0){
    ctrl_reg3.int_s = (uint8_t)val;
    ret = lps22hb_write_reg(ctx, 0x12U, (uint8_t*)&ctrl_reg3, 1);
  }
  return ret;
}
...
{
  int32_t ret;
  ret =  lps22hb_read_reg(ctx, 0x25U, (uint8_t*) val, 1);
  return ret;
}
...
int32_t lps22hb_fifo_watermark_set(lps22hb_ctx_t *ctx, uint8_t val)
{
  ...
  ret = lps22hb_read_reg(ctx, 0x14U, (uint8_t*)&fifo_ctrl, 1);
  if(ret == 0){
    fifo_ctrl.wtm = val;
    ret = lps22hb_write_reg(ctx, 0x14U, (uint8_t*)&fifo_ctrl, 1);
  }
  return ret;
}
...
int32_t lps22hb_fifo_data_level_get(lps22hb_ctx_t *ctx, uint8_t *val)
{
  ...
  ret = lps22hb_read_reg(ctx, 0x26U, (uint8_t*)&fifo_status, 1);
  *val = fifo_status.fss;
