...
extern volatile uint8_t UartRxBuffer[(2 * 256)];
...
#line 46 "..\\Inc\\DemoSerial.h"
#line 47 "..\\Inc\\DemoSerial.h"
#line 1 "..\\Inc\\Serial_CMD.h"
...
#line 46 "..\\Inc\\MotionMC_Manager.h"

#line 1 "..\\..\\..\\..\\..\\..\\Middlewares\\ST\\STM32_MotionMC_Library\\Inc\\motion_mc.h"
...
#line 47 "..\\..\\..\\..\\..\\..\\Middlewares\\ST\\STM32_MotionMC_Library\\Inc\\motion_mc.h"
...
#line 49 "..\\Inc\\MotionMC_Manager.h"

#line 56 "..\\Inc\\MotionMC_Manager.h"

#line 58 "..\\Inc\\MotionMC_Manager.h"
#line 59 "..\\Inc\\MotionMC_Manager.h"
...
#line 77 "..\\Inc\\MotionMC_Manager.h"
...
#line 46 "..\\Inc\\MotionEC_Manager.h"
#line 47 "..\\Inc\\MotionEC_Manager.h"
...
IKS01A2_MOTION_SENSOR_Axes_t MagValueComp;  
  ...
  for (;;)
  {
    ...
    if (SensorReadRequest == 1U)
    {
      if (DataLoggerActive == 1U)
      {
        ...
        RTC_Handler(&msg_dat);
        Accelero_Sensor_Handler(&msg_dat, (1U));
        Gyro_Sensor_Handler(&msg_dat, 0);
        Magneto_Sensor_Handler(&msg_dat, (1U + 1U));
        Humidity_Sensor_Handler(&msg_dat, 0);
        Temperature_Sensor_Handler(&msg_dat, 0);
        Pressure_Sensor_Handler(&msg_dat, (1U));
...
static void Init_Sensors(void)
{
  (void)IKS01A2_MOTION_SENSOR_Init((1U), 2U);
  (void)IKS01A2_MOTION_SENSOR_Init(0, 1U);
  (void)IKS01A2_MOTION_SENSOR_Init((1U + 1U), 4U);
  (void)IKS01A2_ENV_SENSOR_Init(0, 1U | 4U);
  (void)IKS01A2_ENV_SENSOR_Init((1U), 2U);

  


 
  (void)IKS01A2_MOTION_SENSOR_SetOutputDataRate((1U), 2U, 100.0f);
  (void)IKS01A2_MOTION_SENSOR_SetFullScale((1U), 2U, 2);

  


 
  (void)IKS01A2_MOTION_SENSOR_SetOutputDataRate((1U + 1U), 4U, 100.0f);
}
...
static void MX_CRC_Init(void)
{
  do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) |= ((0x1UL << (12U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) & ((0x1UL << (12U)))); (void)tmpreg; } while(0U);
}
...
#line 309 "..\\Src\\main.c"
  ...
  const uint32_t prescaler = 84000000U / 2000U - 1U;
  const uint32_t tim_period = 2000U / 50U - 1U;

  TIM_ClockConfigTypeDef s_clock_source_config;
  TIM_MasterConfigTypeDef s_master_config;

  AlgoTimHandle.Instance           = ((TIM_TypeDef *) (0x40000000UL + 0x0400UL));
  AlgoTimHandle.Init.Prescaler     = prescaler;
  AlgoTimHandle.Init.CounterMode   = 0x00000000U;
  AlgoTimHandle.Init.Period        = tim_period;
  AlgoTimHandle.Init.ClockDivision = 0x00000000U;
  (void)HAL_TIM_Base_Init(&AlgoTimHandle);

  s_clock_source_config.ClockSource = (0x1UL << (12U));
  (void)HAL_TIM_ConfigClockSource(&AlgoTimHandle, &s_clock_source_config);

  s_master_config.MasterOutputTrigger = 0x00000000U;
  s_master_config.MasterSlaveMode     = 0x00000000U;
...
static void RTC_Handler(TMsg *Msg)
{
  ...
  (void)HAL_RTC_GetTime(&RtcHandle, &stimestructure, 0x00000000U);
  (void)HAL_RTC_GetDate(&RtcHandle, &sdatestructureget, 0x00000000U);
...
static void Gyro_Sensor_Handler(TMsg *Msg, uint32_t Instance)
{
  ...
  if ((SensorsEnabled & 0x00000020U) == 0x00000020U)
  {
    (void)IKS01A2_MOTION_SENSOR_GetAxes(Instance, 1U, &gyr_value);
...
static void Pressure_Sensor_Handler(TMsg *Msg, uint32_t Instance)
{
  ...
  if ((SensorsEnabled & 0x00000001U) == 0x00000001U)
  {
    (void)IKS01A2_ENV_SENSOR_GetValue(Instance, 2U, &pres_value);
...
static void Temperature_Sensor_Handler(TMsg *Msg, uint32_t Instance)
{
  ...
  if ((SensorsEnabled & 0x00000002U) == 0x00000002U)
  {
    (void)IKS01A2_ENV_SENSOR_GetValue(Instance, 1U, &temp_value);
...
static void Humidity_Sensor_Handler(TMsg *Msg, uint32_t Instance)
{
  ...
  if ((SensorsEnabled & 0x00000004U) == 0x00000004U)
  {
    (void)IKS01A2_ENV_SENSOR_GetValue(Instance, 4U, &hum_value);
...
static void RTC_Config(void)
{
  ...
  rcc_osc_init_struct.OscillatorType = 0x00000008U | 0x00000004U;
  rcc_osc_init_struct.PLL.PLLState   = ((uint8_t)0x00);
  rcc_osc_init_struct.LSEState       = (0x1UL << (0U));
  rcc_osc_init_struct.LSIState       = ((uint8_t)0x00);
  ...
  else
  {
    ...
    RtcSynchPrediv = 0x00FF;
  }

  RtcHandle.Instance = ((RTC_TypeDef *) (0x40000000UL + 0x2800UL));
  ...
  RtcHandle.Init.HourFormat     = 0x00000040U;
...
static void RTC_TimeStampConfig(void)
{
  ...
  sdatestructure.Month   = ((uint8_t)0x01);
  sdatestructure.Date    = 0x01;
  sdatestructure.WeekDay = ((uint8_t)0x01);
...
void RTC_DateRegulate(uint8_t y, uint8_t m, uint8_t d, uint8_t dw)
{
  ...
  if (HAL_RTC_SetDate(&RtcHandle, &sdatestructure, 0x00000000U) != HAL_OK)
  {
...
void RTC_TimeRegulate(uint8_t hh, uint8_t mm, uint8_t ss)
{
  ...
  if (HAL_RTC_SetTime(&RtcHandle, &stimestructure, 0x00000000U) != HAL_OK)
  {
...
void sensors_enable()
{
        ...
        (void)IKS01A2_ENV_SENSOR_Enable((1U), 2U);
     

     
     
        (void)IKS01A2_ENV_SENSOR_Enable(0, 1U);
     

     
     
        (void)IKS01A2_ENV_SENSOR_Enable(0, 4U);
     

     
      
        (void)IKS01A2_MOTION_SENSOR_Enable((1U), 2U);
     

     
     
        (void)IKS01A2_MOTION_SENSOR_Enable(0, 1U);
     

     
     
        (void)IKS01A2_MOTION_SENSOR_Enable((1U + 1U), 4U);
