...
#line 38 "..\\Src\\stm32f4xx_hal_msp.c"
...
void HAL_RTC_MspInit(RTC_HandleTypeDef *hrtc)
{
  ...
  (*(volatile uint32_t *) (0x42000000UL + (((((0x40000000UL + 0x00020000UL) + 0x3800UL) - 0x40000000UL) + 0x70U) * 32U) + (0x0FU * 4U)) = ENABLE);
...
void HAL_RTC_MspDeInit(RTC_HandleTypeDef *hrtc)
{
  ...
  (*(volatile uint32_t *) (0x42000000UL + (((((0x40000000UL + 0x00020000UL) + 0x3800UL) - 0x40000000UL) + 0x70U) * 32U) + (0x0FU * 4U)) = DISABLE);
}
...
{
  if (htim_base->Instance == ((TIM_TypeDef *) (0x40000000UL + 0x0400UL)))
  {
...
void HAL_CRC_MspInit(CRC_HandleTypeDef *hcrc)
{
  if (hcrc->Instance == ((CRC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3000UL)))
  {
...
void HAL_CRC_MspDeInit(CRC_HandleTypeDef *hcrc)
{
  if (hcrc->Instance == ((CRC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3000UL)))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR &= ~((0x1UL << (12U))));
  }
}
...
void HAL_I2C_MspInit(I2C_HandleTypeDef *hi2c)
{
 ...
 if(hi2c->Instance==((I2C_TypeDef *) (0x40000000UL + 0x5C00UL)))
  {
  ...
  gpio_init.Pin = ((uint16_t)0x0100) | ((uint16_t)0x0200);
  gpio_init.Mode = 0x00000012U;
  gpio_init.Pull = 0x00000001U;
  gpio_init.Speed = 0x00000003U;
  gpio_init.Alternate = ((uint8_t)0x04);

  HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), &gpio_init);
	}
}
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef *hi2c)
{
  ...
  HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0100) | ((uint16_t)0x0200));
	 if(hi2c->Instance==((I2C_TypeDef *) (0x40000000UL + 0x5C00UL)))
  {
