...
#line 303 "..\\..\\..\\..\\..\\..\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_i2c.c"
...
#line 331 "..\\..\\..\\..\\..\\..\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_i2c.c"
...
#line 479 "..\\..\\..\\..\\..\\..\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_i2c.c"
...
#line 567 "..\\..\\..\\..\\..\\..\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_i2c.c"
...
#line 935 "..\\..\\..\\..\\..\\..\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_i2c.c"
...
HAL_StatusTypeDef HAL_I2C_Master_Seq_Transmit_IT(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size, uint32_t XferOptions)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    if ((XferOptions == 0x00000008U) || (XferOptions == 0x00000001U))
    {
...
HAL_StatusTypeDef HAL_I2C_Master_Seq_Receive_IT(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size, uint32_t XferOptions)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    if ((hi2c->XferCount == 2U) && ((XferOptions == 0x00000020U) || (XferOptions == (0xAA000000U)) || (XferOptions == 0x00000010U)))
    {
...
static void I2C_Master_SB(I2C_HandleTypeDef *hi2c)
{
  ...
  else
  {
    if (hi2c->Init.AddressingMode == 0x00004000U)
    {
      ...
      if ((hi2c->hdmatx != 0) || (hi2c->hdmarx != 0))
      {
        if ((hi2c->hdmatx->XferCpltCallback != 0) || (hi2c->hdmarx->XferCpltCallback != 0))
        {
