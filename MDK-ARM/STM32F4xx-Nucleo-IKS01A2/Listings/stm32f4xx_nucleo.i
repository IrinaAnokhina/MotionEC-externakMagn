...
#line 42 "..\\..\\..\\..\\..\\..\\Drivers\\BSP\\STM32F4xx-Nucleo\\stm32f4xx_nucleo.c"
...
#line 80 "..\\..\\..\\..\\..\\..\\Drivers\\BSP\\STM32F4xx-Nucleo\\stm32f4xx_nucleo.c"
...
GPIO_TypeDef* GPIO_PORT[1] = {((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL))};

const uint16_t GPIO_PIN[1] = {((uint16_t)0x0020)};

GPIO_TypeDef* BUTTON_PORT[1] = {((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL))}; 
const uint16_t BUTTON_PIN[1] = {((uint16_t)0x2000)}; 
...
uint32_t BSP_GetVersion(void)
{
  return (((0x01) << 24) |((0x02) << 16) |((0x07) << 8 ) |((0x00)));
}
...
static void SPIx_Init(void)
{
  if(HAL_SPI_GetState(&hnucleo_Spi) == HAL_SPI_STATE_RESET)
  {
    ...
    hnucleo_Spi.Instance = ((SPI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3000UL));
    ...
    hnucleo_Spi.Init.BaudRatePrescaler = ((0x2UL << (3U)));
    hnucleo_Spi.Init.Direction = (0x00000000U);
    hnucleo_Spi.Init.CLKPhase = (0x1UL << (0U));
    hnucleo_Spi.Init.CLKPolarity = (0x1UL << (1U));
    hnucleo_Spi.Init.CRCCalculation = (0x00000000U);
    hnucleo_Spi.Init.CRCPolynomial = 7;
    hnucleo_Spi.Init.DataSize = (0x00000000U);
    hnucleo_Spi.Init.FirstBit = (0x00000000U);
    hnucleo_Spi.Init.NSS = (0x1UL << (9U));
    hnucleo_Spi.Init.TIMode = (0x00000000U);
    hnucleo_Spi.Init.Mode = ((0x1UL << (2U)) | (0x1UL << (8U)));
...
void LCD_IO_WriteMultipleData(uint8_t *pData, uint32_t Size)
{
  ...
  else
  {
    ...
    {
      while(((hnucleo_Spi.Instance->SR) & (0x1UL << (1U))) != (0x1UL << (1U)))
      {
      }
       
      *((volatile uint8_t*)&hnucleo_Spi.Instance->DR) = *(pData+1);
      
      while(((hnucleo_Spi.Instance->SR) & (0x1UL << (1U))) != (0x1UL << (1U)))
      {
      }
      *((volatile uint8_t*)&hnucleo_Spi.Instance->DR) = *pData;
      counter--;
      pData += 2;
      }
  
      
    while(((hnucleo_Spi.Instance->SR) & (0x1UL << (7U))) != RESET)
    {
    } 
  } 
...
static void ADCx_MspInit(ADC_HandleTypeDef *hadc)
{
  ...
  do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR) |= ((0x1UL << (8U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR) & ((0x1UL << (8U)))); (void)tmpreg; } while(0U); 
}
...
static void ADCx_MspDeInit(ADC_HandleTypeDef *hadc)
{
  ...
  GPIO_InitStruct.Pin = ((uint16_t)0x0001) ;
  HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), GPIO_InitStruct.Pin);
...
static void ADCx_Init(void)
{
  if(HAL_ADC_GetState(&hnucleo_Adc) == 0x00000000U)
  {
     
    hnucleo_Adc.Instance                   = ((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2000UL));
    hnucleo_Adc.Init.ClockPrescaler        = ((uint32_t)(0x1UL << (16U)));  
    hnucleo_Adc.Init.Resolution            = 0x00000000U;
    hnucleo_Adc.Init.DataAlign             = 0x00000000U;
    hnucleo_Adc.Init.ContinuousConvMode    = DISABLE;
    hnucleo_Adc.Init.DiscontinuousConvMode = DISABLE;
    hnucleo_Adc.Init.ExternalTrigConvEdge  = 0x00000000U;
    hnucleo_Adc.Init.EOCSelection          = 0x00000001U;
...
uint8_t BSP_JOY_Init(void)
{
  ...
  sConfig.Channel = ((uint32_t)(0x08UL << (0U)));
...
JOYState_TypeDef BSP_JOY_GetState(void)
{
  ...
  if(((HAL_ADC_GetState(&hnucleo_Adc) & 0x00000200U) == 0x00000200U))
  {
